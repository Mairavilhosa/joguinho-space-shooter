...
// movimento e criação da arminha da nave
...
//nave desce
function moveDown() {
    let downPosition = getComputedStyle(yourShip).getPropertyValue('down');
    if(downPosition === "520px"){
        return
    } else {
        let position = parseInt(downPosition);
        position += 50;
        yourShip.style.top = `${position}px`;
    }
}
